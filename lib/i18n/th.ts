...
export const th: Translations = {
  ...
  aiCheck: {
    ...
    criteriaItems: [
      { label: 'AI รู้จักไหม', max: '25', desc: 'AI รู้จักเว็บไซต์หรือองค์กรนี้หรือเปล่า?' },
      { label: 'ความถูกต้อง', max: '20', desc: 'ข้อมูลที่ AI รู้ถูกต้องและเป็นปัจจุบันไหม?' },
      { label: 'รู้ URL', max: '10', desc: 'AI บอก URL ของเว็บไซต์ได้ถูกต้องไหม?' },
      { label: 'ความลึกข้อมูล', max: '15', desc: 'AI รู้ลึกแค่ไหน? (ประวัติ, ผู้บริหาร, คู่แข่ง)' },
      { label: 'สินค้า/บริการ', max: '15', desc: 'AI บอกชื่อสินค้าหรือบริการเฉพาะได้ไหม?' },
      { label: 'ติด Google', max: '15', desc: 'แบรนด์ติดอันดับต้นๆ ของ Google ไหม?' },
    ],
    summary: 'สรุป',
    details: 'รายละเอียด',
    model: 'โมเดล',
